...
public class NametagManager {
  ...
  public static void renderWaypointName(String name, double x, double y, double z) {
    ...
    double newX = x - Minecraft.getMinecraft().getRenderManager().viewerPosX;
    double newY = y - Minecraft.getMinecraft().getRenderManager().viewerPosY;
    double newZ = z - Minecraft.getMinecraft().getRenderManager().viewerPosZ;
